...
async def process_file(
    client: AsyncOpenAI, file_path: str, categories: List[str]
) -> None:
    """
...
async def process_files(
    ...
    with Progress() as progress:
        ...
        async def process_and_update(file_path: str) -> None:
            await process_file(client, file_path, categories)
...
def main(
    ...
    if preview_only:
        ...
        asyncio.run(process_files(root_dir, api_key, use_categories))
